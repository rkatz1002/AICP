...
urlpatterns = [
    ...
    re_path('imprimirEtiquetaMedicamento', views.imprimirEtiquetaMedicamento, name="imprimirEtiquetaMedicamento"), 
    re_path('imprimirEtiquetaPaciente', views.imprimirEtiquetaPaciente, name="imprimirEtiquetaPaciente"), 
]